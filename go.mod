...
require (
	...
	github.com/newrelic/go-agent/v3/integrations/logcontext-v2/zerologWriter v1.0.3 // indirect
	github.com/newrelic/go-agent/v3/integrations/nrzerolog v1.0.0 // indirect
